function initPager($parent) {
    ...
    $parent.find('#pager_prev').bind('click', function () { setPagePost(currentPage() - 1); return false; });
    $parent.find('#pager_next').bind('click', function () { setPagePost(currentPage() + 1); return false; });
